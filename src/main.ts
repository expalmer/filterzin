...
class App {
  ...
  constructor() {
    this.$users = document.querySelector("#users") as HTMLUListElement;
    this.$tags = document.querySelector("#tags") as HTMLUListElement;
    this.$cards = document.querySelector("#cards") as HTMLUListElement;
